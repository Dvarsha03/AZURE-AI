...
workspace_name = "NASA-AUTOMATEDML" # PLACEHOLDER
subscription_id = "42032ad4-24fc-45d8-adfe-bb741f014bc9" # PLACEHOLDER
resource_group = "deakinuni" # PLACEHOLDER
experiment_name = "Default" # PLACEHOLDER
iteration = "12"  # PLACEHOLDER
run_id = "dreamy_arch_qcxpbfwwd7_12"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'is_subgraph_orchestration':False,'is_automode':True,'path':'./sample_projects/Default','subscription_id':'42032ad4-24fc-45d8-adfe-bb741f014bc9','resource_group':'deakinuni','workspace_name':'NASA-AUTOMATEDML','compute_target':'Machinelearningtask-cc','iterations':20,'primary_metric':'AUC_weighted','task_type':'classification','IsImageTask':False,'IsTextDNNTask':False,'n_cross_validations':None,'preprocess':True,'is_timeseries':False,'time_column_name':None,'grain_column_names':None,'max_cores_per_iteration':-1,'max_concurrent_iterations':1,'max_nodes':1,'iteration_timeout_minutes':30,'enforce_time_on_windows':False,'experiment_timeout_minutes':118,'exit_score':'NaN','experiment_exit_score':'NaN','whitelist_models':None,'blacklist_models':None,'blacklist_algos':['TensorFlowLinearClassifier','TensorFlowDNN'],'auto_blacklist':False,'blacklist_samples_reached':False,'exclude_nan_labels':False,'verbosity':20,'model_explainability':True,'enable_onnx_compatible_models':False,'enable_feature_sweeping':False,'send_telemetry':True,'enable_early_stopping':False,'early_stopping_n_iters':20,'distributed_dnn_max_node_check':False,'enable_distributed_featurization':True,'enable_distributed_dnn_training':True,'enable_distributed_dnn_training_ort_ds':False,'ensemble_iterations':15,'enable_tf':False,'enable_cache':False,'enable_subsampling':False,'metric_operation':'maximize','enable_streaming':False,'use_incremental_learning_override':False,'force_streaming':False,'enable_dnn':False,'is_gpu_tmp':False,'enable_run_restructure':False,'featurization':'auto','vm_priority':'dedicated','label_column_name':'pha','weight_column_name':None,'miro_flight':'default','many_models':False,'many_models_process_count_per_node':0,'automl_many_models_scenario':None,'enable_batch_run':True,'save_mlflow':True,'track_child_runs':True,'test_include_predictions_only':False,'enable_mltable_quick_profile':'True','has_multiple_series':False,'_enable_future_regressors':False,'enable_ensembling':True,'enable_stack_ensembling':False,'ensemble_download_models_timeout_sec':300.0,'stack_meta_learner_train_percentage':0.2,'vm_type':'Standard_DS3_v2','process_count_per_instance':0,'gpu_memory_gb':0.0} # PLACEHOLDER
pipeline_spec = "{\"objects\": [{\"class_name\": \"StandardScaler\", \"module\": \"sklearn.preprocessing\", \"param_args\": [], \"param_kwargs\": {\"with_mean\": false, \"with_std\": false}, \"prepared_kwargs\": {}, \"spec_class\": \"preproc\"}, {\"class_name\": \"XGBoostClassifier\", \"module\": \"automl.client.core.common.model_wrappers\", \"param_args\": [], \"param_kwargs\": {\"booster\": \"gbtree\", \"colsample_bytree\": 0.9, \"eta\": 0.1, \"gamma\": 0, \"max_depth\": 6, \"max_leaves\": 3, \"n_estimators\": 25, \"objective\": \"reg:logistic\", \"reg_alpha\": 0, \"reg_lambda\": 0.7291666666666667, \"subsample\": 0.5, \"tree_method\": \"auto\"}, \"prepared_kwargs\": {}, \"spec_class\": \"sklearn\"}], \"pipeline_id\": \"c74787cd2f0507b852a1ac70d504d83ac9bdec83\", \"module\": \"sklearn.pipeline\", \"class_name\": \"Pipeline\", \"pipeline_name\": \"{ StandardScaler, XGBoostClassifier }\"}" # PLACEHOLDER
pipeline_id = "c74787cd2f0507b852a1ac70d504d83ac9bdec83" # PLACEHOLDER
dataprep_json = None # PLACEHOLDER
mltable_data_json = "{\"Type\":\"MLTable\",\"TrainData\":{\"Uri\":\"azureml://locations/australiaeast/workspaces/e3254a97-323a-4dc2-a699-db3133aff23f/data/NASA_DATASET/versions/1\",\"ResolvedUri\":\"azureml://locations/australiaeast/workspaces/e3254a97-323a-4dc2-a699-db3133aff23f/data/NASA_DATASET/versions/1\",\"AssetId\":\"azureml://locations/australiaeast/workspaces/e3254a97-323a-4dc2-a699-db3133aff23f/data/NASA_DATASET/versions/1\"},\"TestData\":null,\"ValidData\":null}" # PLACEHOLDER
